...
function ExploreNearby({ item }: itemTypes) {
  return (
    <div className="flex items-center cursor-pointer px-3 dark:hover:bg-zinc-700 hover:bg-gray-300 rounded-md py-4 group shadow-md transition-all duration-300 overflow-hidden">
