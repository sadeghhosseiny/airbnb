...
function GifBanner() {
  return (
    <div className="relative sm:mx-12 max-w-6xl xl:mx-auto rounded-xl p-5 lg:p-10 my-7 bg-white dark:bg-gray-900 transition duration-300 shadow-lg">
      ...
      <div className="absolute max-w-xs bg-white dark:bg-gray-900 dark:text-gray-200 transition duration-300 shadow-md left-0 bottom-0 sm:left-9 sm:bottom-9 lg:left-16 lg:bottom-24 px-4 py-6 rounded-lg">
